...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_jackal.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"An Armed Jackal is being Repaired by Soldiers. Kill the Soldiers and get the Jackal!"];
...
else
{
	...
	_msgWIN = ['#0080ff',format ["Convicts have killed all soldiers and took the Jackal, entry code %1...",_pinCode]];
};
...
_msgLOSE = ['#FF0000',"The Soldiers fixed the Jackal and Escaped"];

// Define mission name (for map marker and logging)
_missionName = "Armed Jackal";
