...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_shootingRange.sqf with invalid parameters: %1",_this];
};
...
switch (_difficulty) do
{
	case "easy":
	{
		...
		_crate_weapon_list	= ["CUP_srifle_ksvk","CUP_srifle_AS50","arifle_MXM_Black_F","srifle_DMR_01_F","srifle_EBR_F","srifle_GM6_camo_F","srifle_LRR_camo_F"];
		_crate_items 		= (8 + (round (random 3)));
		_crate_item_list	= ["CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x99_as50_M","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","30Rnd_65x39_caseless_mag","30Rnd_556x45_Stanag"];
	...
	_crate_weapon_list	= ["CUP_srifle_ksvk","CUP_srifle_AS50","srifle_DMR_03_khaki_F","srifle_DMR_03_tan_F","srifle_DMR_03_woodland_F","srifle_DMR_05_blk_F","srifle_DMR_05_hex_F","srifle_DMR_06_camo_F","srifle_DMR_06_olive_F","srifle_EBR_F","srifle_GM6_camo_F","srifle_LRR_camo_F"];
	_crate_items 		= (14 + (round (random 3)));
	_crate_item_list	= ["CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x99_as50_M","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","30Rnd_65x39_caseless_mag","30Rnd_556x45_Stanag"];
	...
	default
	{
		...
		_crate_weapons 		= (16 + (round (random 2)));
		_crate_weapon_list	= ["CUP_srifle_ksvk","CUP_srifle_AS50","srifle_DMR_02_camo_F","srifle_DMR_02_sniper_F","srifle_DMR_03_khaki_F","srifle_DMR_03_multicam_F","srifle_DMR_03_woodland_F","srifle_DMR_04_F","srifle_DMR_04_Tan_F","srifle_DMR_05_blk_F","srifle_DMR_05_hex_F","srifle_DMR_05_tan_f","srifle_DMR_06_camo_F","srifle_DMR_06_olive_F","srifle_EBR_F","srifle_GM6_camo_F","srifle_LRR_camo_F"];
		_crate_items 		= (17 + (round (random 3)));
		_crate_item_list	= ["CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x108_KSVK_M","CUP_5Rnd_127x99_as50_M","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","30Rnd_65x39_caseless_mag","16Rnd_9x21_Mag","100Rnd_65x39_caseless_mag","10Rnd_127x54_Mag","16Rnd_9x21_Mag","30Rnd_65x39_caseless_mag","30Rnd_556x45_Stanag"];
...
_msgStart = ['#FFFF00',"Snipers are target practicing, kill them and grab the snipers!"];
...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["Exile_Car_Ural_Covered_Military",[(_pos select 0) +25, (_pos select 1) -0],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#0080ff',format ["Convicts have killed the snipers and stolen their rifles ,the code of the truck is %1...",_pinCode]];
	_group =
	[
...
{
	_vehicle = ["Exile_Car_Ural_Covered_Military",[(_pos select 0) +25.2, (_pos select 1) -0,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
...
_msgLOSE = ['#FF0000',"The Snipers are done Target Practicing and got drunk and shot each other."];

// Define mission name (for map marker and logging) - same for all levels
_missionName = "Sniper Target Practicing";
