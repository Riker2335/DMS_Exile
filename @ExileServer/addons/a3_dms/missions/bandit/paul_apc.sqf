...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_apc.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"The government has send soldiers to try reduce the population. Kill the soldiers and take their APC!"];
...
else
{
	...
	_msgWIN = ['#0080ff',format ["The Soldiers have been killed by Convicts and they're stealing the APC, entry code %1...",_pinCode]];
};
...
_msgLOSE = ['#FF0000',"The Soldiers got bored and left the area..."];

// Define mission name (for map marker and logging)
_missionName = "APC Takeover";
