...
_msgStart = ['#FFFF00',"A group of doctors are building a campfire. Take out those doctors and get the supplies!"];
//HIER MEOTEN NOG GOEUE STUFF IN DE CRATES
_crate_item_list	= ["Exile_Item_InstaDoc","Exile_Item_Bandage","Exile_Item_Vishpirin"];
...
if (_difficulty isEqualTo "difficult") then {
												...
												_vehicle = ["Exile_Car_HMMWV_M2_Green",[(_pos select 0) -30, (_pos select 1) -30],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
												_msgWIN = ['#0080ff',format ["The Prisoners have been eliminated and the Building Supplies are stolen! Entry Code of Armed HMMWV is",_pinCode]];
											} else
											{
												_vehicle = ["Exile_Car_HMMWV_M2_Green",[(_pos select 0) -30, (_pos select 1) -30,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
...
_msgLOSE = ['#FF0000',"The doctors packed their stuff and moved on"];

// Define mission name (for map marker and logging)
_missionName = "Camping Doctors";
