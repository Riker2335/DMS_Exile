...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_water_mission.sqf with invalid parameters: %1",_this];
};
...
_msgLOSE = ['#FF0000',"The Prisoners drank enough to move on..."];

// Define mission name (for map marker and logging)
_missionName = "Thirsty Prisoners";
