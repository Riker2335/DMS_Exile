...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_littlebird_mission.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"A Littlebird Crash Landed at a Small Military Base. Kill the Military while they're reparing the Littlebird, and Steal it!"];
...
else
{
	...
	_msgWIN = ['#0080ff',format ["Convicts killed the Military and toke off with the Littlebird, entry code %1...",_pinCode]];
};
...
_msgLOSE = ['#FF0000',"The attackers flew off with the Littlebird and the base escaped attack."];

// Define mission name (for map marker and logging)
_missionName = "Littlebird Steal";
