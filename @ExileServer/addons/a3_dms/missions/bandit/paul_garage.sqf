...
_msgStart = ['#FFFF00',"Soldiers are repairing a Varsuk at their garage. Wipe them out, take the tank."];
...
if (_difficulty isEqualTo "hardcore") then {
												...
												_vehicle = ["O_MBT_02_cannon_F",[(_pos select 0) -20, (_pos select 1) -20],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
												_msgWIN = ['#0080ff',format ["Convicts killed the soldiers, entry code of HMMWV Avenger is %1...",_pinCode]];
											} else
											{
...
_msgLOSE = ['#FF0000',"The HMMWV Avenger has been repaired and they're gona use it for military purposes..."];
