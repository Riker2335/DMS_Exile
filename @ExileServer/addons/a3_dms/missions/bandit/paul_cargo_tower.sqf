...
switch (_difficulty) do
{
	...
	case "difficult":
	{
		...
		_crate_weapons 		= (15 + (round (random 0)));
	...
	default
	{
		...
		_crate_weapons 		= (20 + (round (random 0)));
...
_msgStart = ['#FFFF00',"Prisoners have setup a Cargo Tower and are defending guns. Let no one escape and get the guns, and steal the M163!"];


_crate_item_list = ["SatchelCharge_Remote_Mag","HandGernade","U_I_FullGhillie_ard","U_B_FullGhillie_sard","U_O_FullGhillie_ard","U_I_FullGhillie_sard","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag_Tracer","10Rnd_127x54_Mag","10Rnd_338_Mag","10Rnd_762x54_Mag","10Rnd_762x51_Mag","150Rnd_762x51_Box","10Rnd_93x64_DMR_05_Mag","11Rnd_45ACP_Mag","150Rnd_762x54_Box","150Rnd_762x54_Box_Tracer","150Rnd_762x51_Box_Tracer","16Rnd_9x21_Mag","30Rnd_9x21_Green_Mag","30Rnd_9x21_Yellow_Mag","30Rnd_9x21_Red_Mag","200Rnd_65x39_cased_Box","200Rnd_65x39_cased_Box_Tracer","20Rnd_556x45_UW_mag","20Rnd_762x51_Mag","30Rnd_45ACP_Mag_SMG_01"];



_group =
	[
		[(_pos select 0)+0.1,(_pos select 1)+0.1,15.5],					// Position AI in tent
...
[
	[
		...
		[(_pos select 0) -(2-(random 0.5)),(_pos select 1)-(2-(random 0.5)),15.7],
		[(_pos select 0) -(2+(random 0.5)),(_pos select 1)-(2+(random 0.5)),22.3]
	],
	_group,
	"assault",
	"static",
...
if (_difficulty isEqualTo "hardcore") then {
												...
												_vehicle = ["CUP_B_M163_USA",_pos getPos [30, random 360],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
												_msgWIN = ['#0080ff',format ["The Cargo Tower has been Captured and the Guns are Stolen, entry code for M163 is %1...",_pinCode]];
											} else
											{
												_vehicle = ["CUP_B_M163_USA",[(_pos select 0) -15, (_pos select 1) -15,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
...
_missionObjs =
[
	_staticGuns+_baseObjs,		// armed AI vehicle, base objects, and static guns
...
_msgLOSE = ['#FF0000',"The Cargo Tower has been destroyed. No Guns for You."];

// Define mission name (for map marker and logging)
_missionName = "Cargo Tower";
