...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION paul_highend_Mission.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',"An Armed Dingo is being protected by Soldiers. Kill the Soldiers and get the Dingo!"];
...
else
{
	...
	_msgWIN = ['#0080ff',format ["The Dingo has been secured, entry code %1...",_pinCode]];
};
...
_msgLOSE = ['#FF0000',"The Dingo is back in business by the Soldiers! No Dingo for you."];

// Define mission name (for map marker and logging)
_missionName = "Armed Dingo";
